...
import { FormControl, Validators, FormGroup, FormBuilder, ReactiveFormsModule, FormsModule } from '@angular/forms';
...
export class UpdateMovieComponent {
  ...
  inlineNotification = { show: false, type: '', text: '' };
  movieForm: any;
  fb: any;
  constructor(
  ...
  onFileSelected(event: any) {
    ...
    this.updateMovieForm.patchValue({ selectedFile: this.selectedFile });
  }
...
updateMovie() {
  ...
  complete: ( ) => {
    ...
    console.log("Form is invalid or user not authenticated");
  }
}
  cancel() {
