...
addMovieService(movieDto: MovieDto, file: File | null): Observable<MovieDto> {
    ...
    deleteMovieService(movieId: number): Observable<string> {
        return this.http.delete(`${this.BASE_URL}/api/v1/movie/delete/${movieId}`, { responseType: "text" as "json" }) as Observable<string>;
    } 
}
